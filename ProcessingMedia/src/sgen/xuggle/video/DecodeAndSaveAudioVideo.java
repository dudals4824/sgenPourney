 ...
 public static void main(String[] args)
  {
    ...
    String filenamevideo = "C:/image/new.mp4"; //this is the input file for video. you can change extension
    String filenameaudio = "C:/image/hypnotize.mp3"; //this is the input file for audio. you can change extension


    IMediaWriter mWriter = ToolFactory.makeWriter("C:/image/audio.mp4"); //output file
